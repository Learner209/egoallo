...
@jaxtyped(typechecker=typeguard.typechecked)
def body_fitting_loss(body_pose: Float[Tensor, "batch_size 69"], betas: Float[Tensor, "batch_size 10"], model_joints: Float[Tensor, "batch_size 24"], camera_t: Float[Tensor, "batch_size 3"], camera_center: Float[Tensor, "batch_size 2"],
                      joints_2d: Float[Tensor, "batch_size 24"], joints_conf: Float[Tensor, "batch_size 24"], pose_prior: Float[Tensor, "batch_size 24"],
...
def camera_fitting_loss(model_joints, camera_t, camera_t_est, camera_center, 
 ...
 # #####--- body fitiing loss -----
@jaxtyped(typechecker=typeguard.typechecked)
def body_fitting_loss_3d(body_pose: Float[Tensor, "batch_size 69"], preserve_pose: Float[Tensor, "batch_size 69"],
                         betas: Float[Tensor, "batch_size 10"], model_joints: Float[Tensor, "batch_size 22 3"], camera_translation: Float[Tensor, "batch_size 3"],
                         j3d: Float[Tensor, "batch_size 22 3"], pose_prior: MaxMixturePrior,
    ...
    joint3d_loss_part = (joints3d_conf ** 2) * joint3d_error.sum(dim=-1) # average over x,y,z 3d. conf is confidence level of each joint.
...
# #####--- get camera fitting loss -----
@jaxtyped(typechecker=typeguard.typechecked)
def camera_fitting_loss_3d(j3d_est: Float[Tensor, "batch_size 45 3"], camera_translation: Float[Tensor, "batch_size 3"], camera_t_est: Float[Tensor, "batch_size 3"],
                           j3d_gt: Float[Tensor, "batch_size 22 3"], joints_category: str = "orig", depth_loss_weight: float = 100.0):
    """
    Loss function for camera optimization.
    """
    ...
    if joints_category=="orig":
        ...
        select_joints_ind = [joints2smpl_config.AMASS_JOINT_MAP[joint] for joint in gt_joints]
    else:
        print("NO SUCH JOINTS CATEGORY!")

    j3d_error_loss = (j3d_gt[:, select_joints_ind] -
                      j3d_est[:, gt_joints_ind]) ** 2
