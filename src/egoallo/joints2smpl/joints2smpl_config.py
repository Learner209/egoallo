...
SMPL_MEAN_FILE = os.path.join(os.path.dirname(__file__), "smpl_models/neutral_smpl_mean_params.h5")
# for collsion 
Part_Seg_DIR = os.path.join(os.path.dirname(__file__), "smpl_models/smplx_parts_segm.pkl")