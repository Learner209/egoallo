...
parser.add_argument(
    '--exp-id', default='default', type=str,
    help='Experiment ID',
)
...
parser.add_argument(
    '--dist-url', default='tcp://192.168.1.219:23456', type=str,
