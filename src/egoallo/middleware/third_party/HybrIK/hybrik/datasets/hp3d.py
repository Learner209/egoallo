...
from hybrik.utils.pose_utils import (
    cam2pixel_matrix, pixel2cam_matrix,
...
class HP3D(data.Dataset):
    ...
    def evaluate_xyz_17(self, preds, result_dir):
        ...
        for n in range(sample_num):
            ...
            # prediction save
            pred_save.append({
                'img_name': img_name, 'joint_cam': pred_3d_kpt.tolist(
                ), 'bbox': [float(_) for _ in bbox], 'root_cam': gt_3d_root.tolist(),
