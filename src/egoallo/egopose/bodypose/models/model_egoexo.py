...
class ModelEgoExo4D(ModelBase):
    ...
    def __init__(self, opt):
        ...
        self.max_win_seg = self.opt['netG']['max_win_seg'] # for sliding window as continous window would GPU OOM.
    ...
    def optimize_parameters(self, current_step):
        ...
        pred = self.E_global_orientation.reshape(B,NUM_OF_BODY_JOINTS,3)[self.visible[:,-1].bool()]
            ...
            with torch.no_grad():
                ...
                if self.L.shape[0] < window_size:
                    ...
                    if input_singleframe:
                        ...
                        for frame_idx in range(0,self.L.shape[0]):
                            E_global_orientation = self.netG(self.L[0:frame_idx+1].unsqueeze(0)) # (BS)1 x (frame_idx) x 3
                    ...
                    if input_singleframe:
                        ...
                        E_global_orientation_tensor_1 = torch.cat(E_global_orientation_list_1, dim=0)
                    ...
                    E_global_orientation_tensor_2 = torch.cat(E_global_orientation_list_2, dim=0)
 
                    E_global_orientation_tensor = torch.cat([E_global_orientation_tensor_1,E_global_orientation_tensor_2], dim=0)
