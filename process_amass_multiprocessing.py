...
from third_party.humor.humor.utils.transforms import batch_rodrigues, compute_world2aligned_mat, compute_world2aligned_joints_mat, axisangle2matrots
...
def process_seq(data_paths):
    ...
    print('Processing: %s, Seq process time: %f s' % (input_file_path, time.time() - start_t))
    return True
